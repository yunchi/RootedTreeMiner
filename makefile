...
RootedTreeMiner: RootedTreeMiner.o RFrequentTreeList.o RFrequentTreeFamily.o RBFCFTree.o RDFCFTree.o RFreeTree.o
	${GCC} -o RootedTreeMiner RootedTreeMiner.o RFrequentTreeList.o RFrequentTreeFamily.o RBFCFTree.o RDFCFTree.o RFreeTree.o;
	rm -f ${OBJS}
